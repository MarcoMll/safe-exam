...
class ObjectDetector:
    ...
    def check_for_object(self, results: list[Results], target_class_id: int):
        """
        ...
        :param target_class_id: class index
        ...
        return (max_confidence >= 0.25), max_confidence

    def count_class(self, results: list[Results], target_class_id: int) -> int:
        count = 0
